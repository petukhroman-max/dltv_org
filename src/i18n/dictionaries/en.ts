...
export const en = {
  ...
  home: {
    ...
    statusDescription:
      "Submission, moderation, organizer operations, and localized public tournament data are implemented, together with brackets, standings, spreadsheet imports, and an authenticated public API.",
    statusScope: [
      "Tournament submission and moderation review",
      "Organizer workspace for stages, teams, rosters, and matches",
      "Brackets and standings",
      "XLSX and Google Sheets imports",
      "Authenticated Public API v1",
      "Localized public tournament pages and catalog",
    ],
  ...
  footer: {
    ...
    aboutTitle: "About",
    aboutDescription:
      "DLTV Organizer Portal keeps Deadlock tournament review, organizer operations, and published public data in one place.",
    resourcesTitle: "Resources",
    dataTitle: "Data and attribution",
    catalogLink: "Tournament catalog",
    submitLink: "Add your tournament",
    apiDocsLink: "API documentation",
    apiAccessLink: "API access request",
    apiTermsLink: "API terms",
    attribution: "Data provided by DLTV",
    termsVersion: "Terms version",
    copyright: "© {year} DLTV",
    apiStatusLabel: "Public API status",
    apiStatusChecking: "Checking API",
    apiStatusOnline: "API online",
    apiStatusDegraded: "API degraded",
    apiStatusOffline: "API unreachable",
    apiStatusCheckedAt: "Response at {time}",
  },
  catalog: {
